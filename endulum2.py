...
def func(t, int_error, q1_desirable, q0, kp, ki):
...
sol = func(t, int_error, q1_desirable, q0, kp, ki)
...
plt.plot(time_list, position_list, color='c', label="При K_p = {} и К_i = {}".format(kp, ki), linewidth=2)
